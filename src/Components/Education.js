...
export default function Education() {
  return (
    <>
    <div className="flex justify-center align-middle   pt-[100px]  lg:pt-[100px] " id="education">
    <p className="text-4xl   lg:text-5xl font-heading">EDUCATION</p> 
    </div> 

    <div className=" grid grid-rows-3  pb-[50px] lg:grid lg:grid-rows-2  lg:grid-cols-2 lg:pl-[100px]" >

        <div className="  mt-[50px] bg-gray-500 h-[220px] w-[320px] ml-[20px] rounded-lg border-4 border-black lg:w-[550px] lg:pl-[40px]  " >
           <p className=" text-4xl underline  font-bold flex justify-center pb-4 ">School</p>
        ...
        <div className="  mt-[50px] bg-gray-500 h-[220px] w-[320px] ml-[20px] rounded-lg border-4 border-black lg:w-[550px] lg:pl-[40px] " >
           <p className=" text-4xl underline  font-bold flex justify-center pb-4 ">Junior College</p>
        ...
        <div className="  mt-[50px] bg-gray-500 h-[220px] w-[320px] ml-[20px] rounded-lg border-4 border-black lg:w-[550px] lg:pl-[40px] " >
           <p className=" text-4xl underline  font-bold flex justify-center pb-4 ">Degree College</p>
